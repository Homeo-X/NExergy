...
class ThermalFlow:
    ...
    def __post_init__(self) -> None:
        ...
        require_positive(self.source_temperature_k, "source_temperature_k")
        if self.sink_temperature_k is not None:
            require_positive(self.sink_temperature_k, "sink_temperature_k")
        if self.boundary_temperature_k is not None:
            require_positive(self.boundary_temperature_k, "boundary_temperature_k")
